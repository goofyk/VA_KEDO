...
Контекст: 
	...
	И Я запоминаю значение выражения 'Число(286)' в переменную "ДокументИд"
	И Я запоминаю значение выражения 'Число(999)' в переменную "НесуществующийДокументИд"
	И Я запоминаю значение выражения 'Число(226)' в переменную "СотрудникИд"
	И Я запоминаю значение выражения 'Число(999)' в переменную "НесуществующийСотрудникИд"
